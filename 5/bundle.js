...
/* harmony import */ var _mock_film_data_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./mock/film-data.js */ "./src/mock/film-data.js");
/* harmony import */ var _mock_comment_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mock/comment.js */ "./src/mock/comment.js");
/* harmony import */ var _mock_filters_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./mock/filters.js */ "./src/mock/filters.js");
...
const films = new Array(FILMS_MOCK_COUNT).fill().map(_mock_film_data_js__WEBPACK_IMPORTED_MODULE_11__["generateFilmCard"]);
const filters = Object(_mock_filters_js__WEBPACK_IMPORTED_MODULE_13__["generateFilters"])(films);
...
const showPopup = (film, count) => {
  ...
  const newPopupItem = new _view_popup_js__WEBPACK_IMPORTED_MODULE_9__["default"](film).getElement();
  ...
  for (let j = 0; j < count; j++) {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(commentsListContainer, new _view_comments_js__WEBPACK_IMPORTED_MODULE_10__["default"](Object(_mock_comment_js__WEBPACK_IMPORTED_MODULE_12__["generateComment"])()).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  }
...
const renderMovieCards = (container, filmsList, cardsCount, commentsCount) => {
  for (let i = 0; i < Math.min(filmsList.length, cardsCount); i++) {
    const newMovieItem = new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_5__["default"](filmsList[i]).getElement();
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, newMovieItem, _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
...
const renderFilmsList = (type, filmsList, cardsCount, place) => {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(filmsElement, new _view_films_list__WEBPACK_IMPORTED_MODULE_6__["default"](type).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteHeaderElement, new _view_user_rank_js__WEBPACK_IMPORTED_MODULE_1__["default"]().getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);

// рендер меню навигации
Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteMainElement, new _view_filters_js__WEBPACK_IMPORTED_MODULE_2__["default"](filters).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);

// рендер меню фильтров
Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteMainElement, new _view_sort_menu_js__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);

// рендер контейнера для списков фильмов
Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteMainElement, new _view_films_wrapper_js__WEBPACK_IMPORTED_MODULE_7__["default"]().getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
...
if (films.length > CARDS_MAIN_QUANTITY) {
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(filmsListElement, new _view_show_more_js__WEBPACK_IMPORTED_MODULE_4__["default"]().getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  const onShowMoreButtonClick = (evt) => {
    ...
    .forEach((film) => {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(filmsListElement.querySelector(`.films-list__container`), new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_5__["default"](film).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
    });
...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(footerStatisticsElement, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_8__["default"](Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 100000)).getElement, _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
...
const generateEmoji = () => {
  return CommentData.EMOJIS[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, CommentData.EMOJIS.length - 1)];
};

// генерация текста комментария
const generateText = () => {
  return CommentData.RANDOM_SENTENCES[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, CommentData.RANDOM_SENTENCES.length - 1)];
};

// генерация автора комментария
const generateName = () => {
  return CommentData.RANDOM_NAMES[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, CommentData.RANDOM_NAMES.length - 1)];
};

// генерация даты комментария
const generateDate = () => {
  const postDate = new Date(Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1930, 2020), Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 12), Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 31), Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 23), Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 59));
...
const generateCoverImage = () => {
  return FilmData.POSTERS[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.POSTERS.length - 1)];
};

// генерация названия фильма
const generateTitle = () => {
  return FilmData.TITLES[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.TITLES.length - 1)];
};
...
const generateDescription = () => {
  ...
  for (let i = 0; i < sentencesCount; i++) {
    randomDesc.push(FilmData.RANDOM_SENTENCES[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.RANDOM_SENTENCES.length - 1)]);
  }
...
const generateGenres = () => {
  const maxCount = Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, FilmData.GENRES.length - 1);

  const genresList = [];
  for (let i = 0; i < maxCount; i++) {
    genresList.push(FilmData.GENRES[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.GENRES.length - 1)]);
  }
...
const generateReleaseDate = () => {
  return new Date(Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1930, 2020), Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 12), Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 31));
};
...
const generateDirector = () => {
  return FilmData.DIRECTORS[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.DIRECTORS.length - 1)];
};
...
const generateAgeRestriction = () => {
  return FilmData.MPAA_RATING[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.MPAA_RATING.length - 1)];
};

// генерация страны
const generateCountry = () => {
  return FilmData.COUNTRIES[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, FilmData.COUNTRIES.length - 1)];
};
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: RenderPosition, getRandomInteger, turnMinutesToHours, getShortText, getYDate, getDMYDate, getYMDHMDate, renderTemplate, render, createElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    `<li class="film-details__comment">
      ...
      <div>
        ...
        <p class="film-details__comment-info">
          ...
          <span class="film-details__comment-day">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getYMDHMDate"])(date)}</span>
...
const createFilmArticle = (filmCard) => {
  ...
  const shortDescription = Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getShortText"])(description);
  ...
  return (
    `<article class="film-card">
        ...
        <p class="film-card__info">
          <span class="film-card__year">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getYDate"])(releaseDate)}</span>
          ...
          <div class="film-details__info-wrap">
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                ${createFilmDetailItemTemplate(Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getDMYDate"])(releaseDate), `releaseDate`)}
