...
/* harmony import */ var _view_empty_list_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./view/empty-list.js */ "./src/view/empty-list.js");
...
const filmsNumber = Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 100000);
...
const showPopup = (film, count) => {
  ...
  for (let j = 0; j < count; j++) {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(commentsListContainer, new _view_comments_js__WEBPACK_IMPORTED_MODULE_10__["default"](Object(_mock_comment_js__WEBPACK_IMPORTED_MODULE_13__["generateComment"])()).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  }
  ...
  const onClosePopupEscDown = (evt) => {
    evt.preventDefault();
    if (evt.key === _utils_js__WEBPACK_IMPORTED_MODULE_0__["KeyBindings"].KEY_ESCAPE) {
...
if (filmsNumber === 0) {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(filmsElement, new _view_empty_list_js__WEBPACK_IMPORTED_MODULE_11__["default"]().getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
} else {
...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(footerStatisticsElement, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_8__["default"](filmsNumber).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: RenderPosition, KeyBindings, getRandomInteger, turnMinutesToHours, getShortText, getYDate, getDMYDate, getYMDHMDate, renderTemplate, render, createElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
