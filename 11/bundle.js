...
/* harmony import */ var _mock_film_data_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/film-data.js */ "./src/mock/film-data.js");
/* harmony import */ var _presenter_movies_list_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./presenter/movies-list.js */ "./src/presenter/movies-list.js");
/* harmony import */ var _presenter_filter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./presenter/filter */ "./src/presenter/filter.js");
...
const films = new Array(FILMS_MOCK_COUNT).fill().map(_mock_film_data_js__WEBPACK_IMPORTED_MODULE_7__["generateFilmCard"]);
...
const commentsModel = new _model_comments_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
const filterPresenter = new _presenter_filter__WEBPACK_IMPORTED_MODULE_9__["default"](siteMainElement, filterModel, moviesModel);
filterPresenter.init();

// рендер списков фильмов
const moviesList = new _presenter_movies_list_js__WEBPACK_IMPORTED_MODULE_8__["default"](siteMainElement, moviesModel, filterModel, commentsModel);
moviesList.init();
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(footerStatisticsElement, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_3__["default"](filmsNumber), _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFORE_END);
...
/*!*****************************!*\
  !*** ./src/mock/comment.js ***!
  \*****************************/
/*! exports provided: generateComment, generateName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const generateDuration = () => {
  return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 210);
};
...
class Filter extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._activeFilter = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES;
  }
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filters_js__WEBPACK_IMPORTED_MODULE_3__["default"](filters, this._currentFilter);
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filterContainer, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._filterComponent, prevFilterComponent);
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MAJOR, filterType);
  }
  ...
  _handleStatsClick(filterType) {
    ...
    this._filterModel.setFilter(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].STATS, filterType);
  }
  ...
  _getFilters() {
    ...
    return [
      {
        type: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES](movies).length,
        text: `All movies`
      },
      {
        type: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCHLIST,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCHLIST](movies).length,
        text: `Watchlist`
      },
      {
        type: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].HISTORY,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].HISTORY](movies).length,
        text: `History`
      },
      {
        type: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITES,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITES](movies).length,
        text: `Favorites`
      },
      {
        type: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].STATS,
        text: `Stats`
      }
    ];
  }
...
/* harmony import */ var _view_movie_card_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/movie-card.js */ "./src/view/movie-card.js");
...
for (let j = 0; j < COMMENTS_QUANTITY; j++) {
  comments.push(Object(_mock_comment_js__WEBPACK_IMPORTED_MODULE_2__["generateComment"])());
}
...
class Movie {
  ...
  init(movie) {
    ...
    this._movieCardView = new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._movie, this._comments);
  ...
  _showPopup() {
    ...
    this._comments = this._commentsModel.getComments();
    this._popupView = new _view_popup_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._movie, this._comments);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(document.body, this._popupView.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  _closePopup() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._popupView);
  }
  ...
  _changeWatchlistStatus() {
    this._changeData(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_MOVIE,
        _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MINOR,
  ...
  _handleDeleteClick(deletedCommentId) {
    this._handleCommentsViewAction(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].DELETE_COMMENT,
        _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH,
  ...
  _handleAddComment(newComment) {
    if (newComment.emoji && newComment.text) {
      this._handleCommentsViewAction(
          _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].ADD_COMMENT,
          _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH,
  ...
  _handleCommentsViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].DELETE_COMMENT:
        this._commentsModel.deleteComment(updateType, update);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].ADD_COMMENT:
  ...
  _handleCommentsModelEvent(updateType) {
    switch (updateType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH:
...
/* harmony import */ var _view_movies_list__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/movies-list */ "./src/view/movies-list.js");
...
/* harmony import */ var _view_stats_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/stats.js */ "./src/view/stats.js");
...
class MoviesList {
  constructor(container, moviesModel, filterModel, commentsModel) {
    ...
    this._filterModel = filterModel;
    this._commentsModel = commentsModel;
    this._renderedMoviesCount = _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_MAIN_QUANTITY;
  ...
  _getMovies(sortButton = this._currentSortButton) {
    ...
    const movies = this._moviesModel.getMovies();
    const filtredMovies = _utils_filter_js__WEBPACK_IMPORTED_MODULE_4__["filter"][filterType](movies);

    switch (sortButton) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_DATE:
        return filtredMovies.slice().sort(_utils_date_time_js__WEBPACK_IMPORTED_MODULE_3__["sortByDate"]);
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_RATE:
        return filtredMovies.slice().sort(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["sortByRate"]);
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_COMMENTS:
        return filtredMovies.slice().sort(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["sortByCommentsCount"]);
    }
  ...
  _renderContainer() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._moviesWrapperComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
    this._moviesElement = this._container.querySelector(`.films`);
  }

  // рендер карточки фильма
  _renderMovieCard(container, movie) {
    const moviePresenter = new _movie_js__WEBPACK_IMPORTED_MODULE_10__["default"](container, this._handleViewAction, this._commentsModel);
  ...
  _renderEmptyList() {
    const moviesListComponent = new _view_movies_list__WEBPACK_IMPORTED_MODULE_6__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["ListTypes"].EMPTY_LIST);
    this._moviesContainerList.push(moviesListComponent);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._moviesElement, moviesListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  }

  // рендер основного списка фильмов "All Movies"
  _renderAllMoviesList() {
    this._allMoviesListComponent = new _view_movies_list__WEBPACK_IMPORTED_MODULE_6__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["ListTypes"].ALL_MOVIES);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._moviesElement, this._allMoviesListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);

    if (this._getMovies().length > _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_MAIN_QUANTITY) {
  ...
  _renderTopRated() {
    this._topRatedListComponent = new _view_movies_list__WEBPACK_IMPORTED_MODULE_6__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["ListTypes"].TOP_RATED);
    this._topRatedContainer = this._topRatedListComponent.getElement();
    const topRatedMoviesCount = Math.min(this._getMovies().length, _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_EXTRA_QUANTITY);

    this._renderMovieCards(this._topRatedContainer.querySelector(`.films-list__container`), this._getMovies(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_RATE).slice(0, topRatedMoviesCount));

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._moviesElement, this._topRatedListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  }

  // рендер дополнительного списка фильмов "Most Commented"
  _renderMostCommented() {
    this._topCommentedListComponent = new _view_movies_list__WEBPACK_IMPORTED_MODULE_6__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["ListTypes"].MOST_COMMENTED);
    this._mostCommentedContainer = this._topCommentedListComponent.getElement();

    const mostCommentedCount = Math.min(this._getMovies().length, _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_EXTRA_QUANTITY);

    this._renderMovieCards(this._mostCommentedContainer.querySelector(`.films-list__container`), this._getMovies(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_COMMENTS).slice(0, mostCommentedCount));

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._moviesElement, this._topCommentedListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  }
  ...
  _clearMoviesList() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._allMoviesListComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._topRatedListComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._topCommentedListComponent);
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_MOVIE:
        this._moviesModel.updateMovie(updateType, update);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].DELETE_COMMENT:
        this._commentsModel.deleteComment(updateType, update);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].ADD_COMMENT:
        this._commentsModel.addComment(updateType, update);
        break;
    }
  }
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH:
        this._moviesList.forEach((presenter) => {
      ...
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR:
        this._clearMoviesContainer();
        this._renderMainMoviesLists();
        break;

      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR:
        this._clearMoviesContainer({resetRenderedMoviesCount: true, resetSortType: true});
        this._renderMainMoviesLists();
        break;

      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].STATS:
        this._clearMoviesContainer({resetSortType: true});

        this._statsComponent = new _view_stats_js__WEBPACK_IMPORTED_MODULE_9__["default"](this._moviesModel.getMovies());
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._statsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
        break;
    }
  }
  ...
  _renderShowMoreButton() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._allMoviesListComponent, this._showMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  _handleShowMoreButtonClick() {
    ...
    const newRenderedMoviesCount = Math.min(moviesCount, this._renderedMoviesCount + _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_MAIN_QUANTITY);
    const movies = this._getMovies().slice(this._renderedMoviesCount, this._renderedMoviesCount + _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_MAIN_QUANTITY);
  ...
  _renderSortMenu() {
    ...
    this._sortMenuComponent = new _view_sort_menu_js__WEBPACK_IMPORTED_MODULE_8__["default"](this._currentSortButton);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._moviesElement, this._sortMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  _clearMoviesContainer({resetRenderedMoviesCount = false, resetSortType = false} = {}) {
    ...
    if (this._statsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._statsComponent);
      this._statsComponent = null;
    }
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getShortText, sortByRate, sortByCommentsCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: SortType, FilmDetails, MoviesListData, UserAction, UpdateType, FilterType, ListTypes, KeyBindings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL_MOVIES]: (movies) => movies,
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (movies) => movies.filter((movie) => movie.isToWatch),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (movies) => movies.filter((movie) => movie.isAlreadyWatched),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (movies) => movies.filter((movie) => movie.isInFavorites)
};
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, renderTemplate, render, createElement, replace, remove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getGenresCountsInMovies, sortByGenresCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGenresCountsInMovies", function() { return getGenresCountsInMovies; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortByGenresCount", function() { return sortByGenresCount; });
...
const createFilterItemTemplate = (filter, currentFilterType, currentMenuItem) => {
  ...
  const activeFilter = currentMenuItem !== _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].STATS
    ? currentFilterType
    : null;

  if (type !== _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].STATS) {
    return (
      `<a
        href="#${type}"
...
const createStatsTemplate = (filter, currentFilterType) => {
  ...
  if (type === _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].STATS) {
    return (
      ...
      ${currentFilterType === _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].STATS
...
const createNavMenuTemplate = (filters, currentFilterType, currentMenuItem) => {
  ...
  return (
    `<nav class="main-navigation">
      ...
      ${createStatsTemplate(filters.find((filter) => filter.type === _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].STATS), currentFilterType, currentMenuItem)}
    </nav>`);
};


class Filters extends _abstract_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  _filterTypeClickHandler(evt) {
    if (evt.target.closest(`.main-navigation__item`)) {
      ...
      if (clickedFilter !== `stats`) {
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(document.querySelector(`.statistics`));
      }
    }
  }
  ...
  return (
    `<article class="film-card">
        ...
        <p class="film-card__info">
          ...
          <span class="film-card__duration">${Object(_utils_date_time_js__WEBPACK_IMPORTED_MODULE_0__["turnMinutesToHours"])(duration)}</span>
...
class MoviesList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const createFilmDetailItemTemplate = (detail, detailName) => {
  return (
    `<tr class="film-details__row">
      <td class="film-details__term">${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilmDetails"][detailName]}</td>
...
const createPopUpTemplate = (data) => {
  ...
  return (
    `<section class="film-details">
          ...
          <div class="film-details__info-wrap">
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                ${createFilmDetailItemTemplate(Object(_utils_date_time_js__WEBPACK_IMPORTED_MODULE_0__["turnMinutesToHours"])(duration), `duration`)}
      ...
      ? `${he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(newComment)}</textarea>`
      : `</textarea>`}
...
class Popup extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  _escPressClosePopupHandler(evt) {
    if (evt.key === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["KeyBindings"].ESCAPE && document.body.contains(this.getElement())) {
      evt.preventDefault();
  ...
  _formSubmitHandler(evt) {
    if (evt.ctrlKey && evt.key === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["KeyBindings"].ENTER) {
      evt.preventDefault();
      this._scrollPosition = this.getElement().scrollTop;
  ...
  static parseDataToLocalComment(data) {
    ...
    localComment.author = Object(_mock_comment_js__WEBPACK_IMPORTED_MODULE_4__["generateName"])();
...
class Smart extends _abstract_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super();
    this._data = {};
  }
  ...
  updateElement() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(newElement, prevElement);
...
const createSortMenuTemplate = (currentSortType) => {
  return (
    `<ul class="sort">
      <li><a href="#" class="sort__button sort__button ${currentSortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT
      ? `sort__button--active`
      : ``}" data-sort-type=${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}>Sort by default</a></li>
      <li><a href="#" class="sort__button ${currentSortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DATE
      ? `sort__button--active`
      : ``}" data-sort-type=${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DATE}>Sort by date</a></li>
      <li><a href="#" class="sort__button ${currentSortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_RATE
      ? `sort__button--active`
      : ``}" data-sort-type=${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_RATE}>Sort by rating</a></li>
    </ul>`
  );
};
...
const getMoviesWatchedCount = (movies) => {
  return _utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["filter"][_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].WATCHLIST](movies).length;
};
...
const getSortedGenreList = (movies) => {
  const unsortedGenresList = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["getGenresCountsInMovies"])(movies);
  return unsortedGenresList.sort(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["sortByGenresCount"]);
};
...
class Stats extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(movies) {
    super();
    this._movies = movies;
  }
