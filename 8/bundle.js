...
/* harmony import */ var _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/footer-stats.js */ "./src/view/footer-stats.js");
...
const filters = Object(_mock_filters_js__WEBPACK_IMPORTED_MODULE_7__["generateFilters"])(films);
...
const moviesList = new _presenter_movies_list_js__WEBPACK_IMPORTED_MODULE_8__["default"](filmsNumber);
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(footerStatisticsElement, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_5__["default"](filmsNumber), _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFORE_END);
...
class Movie {
  ...
  init(movie) {
    this._movie = movie;
    this._movieCard = new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_1__["default"](movie);
    this._newPopupItem = new _view_popup_js__WEBPACK_IMPORTED_MODULE_2__["default"](movie);
    ...
    if (
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._movieCard, prevMovieCard);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._newPopupItem, prevPopupItem);
  ...
  // удаление карточки
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._movieCard);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._newPopupItem);
  }
  ...
  _renderMovieCard() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._movieCard, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  _showPopup() {
    ...
    for (let j = 0; j < this._commentsCount; j++) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(commentsListContainer, new _view_comments_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._generateComment()), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
    }
...
/* harmony import */ var _view_show_more_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/show-more.js */ "./src/view/show-more.js");
...
/* harmony import */ var _view_films_wrapper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/films-wrapper.js */ "./src/view/films-wrapper.js");
/* harmony import */ var _movie_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./movie.js */ "./src/presenter/movie.js");
...
class MoviesList {
  constructor(filmsNumber) {
    this._filmsWrapper = new _view_films_wrapper_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._showMoreButtonItem = new _view_show_more_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._filmsElement = null;
    this._generateComment = _mock_comment_js__WEBPACK_IMPORTED_MODULE_6__["generateComment"];
    this._newPopupItem = null;
  ...
  _renderContainer() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteMainElement, this._filmsWrapper, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  _renderMovieCards(container, filmsList, cardsCount) {
    for (let i = 0; i < Math.min(filmsList.length, cardsCount); i++) {
      const moviePresenter = new _movie_js__WEBPACK_IMPORTED_MODULE_5__["default"](container, _mock_comment_js__WEBPACK_IMPORTED_MODULE_6__["generateComment"], this._handleMovieChange);
  ...
  _renderFilmsList(type, filmsList, cardsCount, place) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filmsElement, new _view_films_list__WEBPACK_IMPORTED_MODULE_3__["default"](type), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
  ...
  _clearMoviesList() {
    ...
    this._moviePresenter = {};
    this._renderedFilmsCount = CARDS_MAIN_QUANTITY;
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._showMoreButtonItem);
  }
  ...
  _renderShowMoreButton() {
    if (this._films.length > CARDS_MAIN_QUANTITY & this._filmsNumber !== 0) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(filmsListElement, this._showMoreButtonItem, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFORE_END);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getShortText, updateItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
