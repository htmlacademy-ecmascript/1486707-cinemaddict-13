...
/* harmony import */ var _mock_film_data_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mock/film-data.js */ "./src/mock/film-data.js");
...
const films = new Array(FILMS_MOCK_COUNT).fill().map(_mock_film_data_js__WEBPACK_IMPORTED_MODULE_6__["generateFilmCard"]);
...
const filterPresenter = new _presenter_filter__WEBPACK_IMPORTED_MODULE_8__["default"](siteMainElement, filterModel, moviesModel);
filterPresenter.init();

const moviesList = new _presenter_movies_list_js__WEBPACK_IMPORTED_MODULE_7__["default"](siteMainElement, moviesModel, filterModel);
moviesList.init();
...
class Movie {
  ...
  init(movie) {
    ...
    this._movieCardView = new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_2__["default"](movie);
    this._newPopupView = new _view_popup_js__WEBPACK_IMPORTED_MODULE_3__["default"](movie, this._commentsComponent);
...
/* harmony import */ var _view_sort_menu_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/sort-menu.js */ "./src/view/sort-menu.js");
...
class MoviesList {
  constructor(container, moviesModel, filterModel) {
    ...
    this._moviesModel = moviesModel;
    this._filterModel = filterModel;
    this._filmsWrapperComponent = new _view_films_wrapper_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this._showMoreButtonComponent = new _view_show_more_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._sortMenuComponent = new _view_sort_menu_js__WEBPACK_IMPORTED_MODULE_9__["default"]();
  ...
  _getMovies() {
    ...
    switch (this._currentSortButton) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_DATE:
        return filtredMovies.sort(_utils_date_time_js__WEBPACK_IMPORTED_MODULE_3__["sortByDate"]);
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_RATE:
        return filtredMovies.sort(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["sortByRate"]);
    }
  ...
  _renderMovieCard(container, film) {
    ...
    const moviePresenter = new _movie_js__WEBPACK_IMPORTED_MODULE_8__["default"](container, this._handleViewAction);
  ...
  _renderEmptyList() {
    const flimsListComponent = new _view_films_list__WEBPACK_IMPORTED_MODULE_6__["default"](ListTypes.EMPTY_LIST);
  ...
  _renderAllMoviesList() {
    const flimsListComponent = new _view_films_list__WEBPACK_IMPORTED_MODULE_6__["default"](ListTypes.ALL_MOVIES);
  ...
  _renderTopRated() {
    const flimsListComponent = new _view_films_list__WEBPACK_IMPORTED_MODULE_6__["default"](ListTypes.TOP_RATED);
    this._topRatedContainer = flimsListComponent.getElement();
    this._filmsContainerList.push(flimsListComponent);

    this._renderMovieCards(this._topRatedContainer.querySelector(`.films-list__container`), this._getMovies(), _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_EXTRA_QUANTITY);
  ...
  _renderMostCommented() {
    const flimsListComponent = new _view_films_list__WEBPACK_IMPORTED_MODULE_6__["default"](ListTypes.MOST_COMMENTED);
    this._mostCommentedContainer = flimsListComponent.getElement();
    this._filmsContainerList.push(flimsListComponent);

    this._renderMovieCards(this._mostCommentedContainer.querySelector(`.films-list__container`), this._getMovies(), _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["MoviesListData"].CARDS_EXTRA_QUANTITY);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getShortText, sortByRate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: SortType, FilmDetails, MoviesListData, UserAction, UpdateType, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (movies) => movies.filter((film) => film.isToWatch),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (movies) => movies.filter((film) => film.isAlreadyWatched),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (movies) => movies.filter((film) => film.isInFavorites)
};
...
class Filters extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setFilterTypeChangeHandler(callback) {
    ...
    this.getElement().querySelector(`a[href="#${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"][`ALL_MOVIES`]}"]`).addEventListener(`click`, this._filterTypeChangeHandler);
    this.getElement().querySelector(`a[href="#${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"][`WATCHLIST`]}"]`).addEventListener(`click`, this._filterTypeChangeHandler);
    this.getElement().querySelector(`a[href="#${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"][`HISTORY`]}"]`).addEventListener(`click`, this._filterTypeChangeHandler);
    this.getElement().querySelector(`a[href="#${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"][`FAVORITES`]}"]`).addEventListener(`click`, this._filterTypeChangeHandler);
  }
}
