...
class Movie {
  ...
  init(movie) {
    ...
    if (prevPopupView !== null && document.body.contains(prevPopupView.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._popupView, prevPopupView);
...
class MoviesList {
  ...
  _renderMovieCard(container, movie) {
    ...
    const moviePresenter = new _movie_js__WEBPACK_IMPORTED_MODULE_9__["default"](container, this._handleViewAction, this._commentsModel);
  ...
  _renderTopRated() {
    ...
    this._renderMovieCards(this._topRatedContainer.querySelector(`.films-list__container`), this._getMovies(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_RATE), topRatedMoviesCount);
  ...
  _renderMostCommented() {
    ...
    this._renderMovieCards(this._mostCommentedContainer.querySelector(`.films-list__container`), this._getMovies(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].BY_COMMENTS), mostCommentedCount);
